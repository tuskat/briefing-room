...
function addNextBits() {
    /* 
     var nextLineUp = document.createElement("li");
     nextLineUp.setAttribute("id", lIndex);
     nextLineUp.innerHTML = movieData.results[0].title;
     */
